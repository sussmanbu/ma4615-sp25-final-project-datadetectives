...
This boxplot shows the total income for the year 2010 of people aged 45-53. Additionally, the data is split by sex and race to analyze any disparities. Firstly, there is no visible change for income depending on age. However, across all race groups, males tend to have higher incomes. Similarly, non-black and non-hispanic groups tend to have higher incomes regardless of gender. Like the other graphs, there were signficant outliers present, which likely led to the to positive skew visible in this graph. 
